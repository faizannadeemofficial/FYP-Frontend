...
const FileUploadPage = () => {
  ...
  const [customWords, setCustomWords] = useState(['damn', 'hell', 'stupid', 'idiot', 'hate', 'dead', 'naughty']);
        ...
        if (response.ok) {
          ...
          navigate('/image-output', {
            state: {
              ...
              // For completeness, also pass blur_radius and original file name
  ...
  const handleCustomMaskCharChange = (e) => {
    ...
    // Use Array.from to handle emoji/unicode properly (single grapheme)
        ...
        <div className="flex flex-col flex-1 gap-5">
          ...
          <div
            ...
            onDrop={e => {
              ...
              if (file && (file.type.startsWith('image/') || file.type.startsWith('audio/') || file.type.startsWith('video/'))) {
